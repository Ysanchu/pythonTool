...
def MKChk():
    ...
    #testXml  = html.xpath('//*[@id="main"]/div[3]/table/tbody/tr[2]/td[2]/dl/dd')
    testXml  = html.xpath('//*[@id="main"]/div/table/tbody/tr[2]/td[2]/dl/dd')
    print(testXml[0].text)
    #print(testXml[1].text)
    for index , item in enumerate(testXml):
